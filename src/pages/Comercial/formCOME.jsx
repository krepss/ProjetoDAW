...
export const FormularioCOME = () => {
    ...
    const valorInput = e => setComercial({ ...comercial, [e.target.name]: e.target.value });

    //enviando os dados
    const cadComercial = async e => {

        await fetch("http://localhost/ProjectWEB/cadTarefaCome.php", {
            method: "POST",
            headers: {
...
{/* 
            ...
            <form className={showForm ? 'nform' : 'nform-click'} onSubmit={cadComercial}>
